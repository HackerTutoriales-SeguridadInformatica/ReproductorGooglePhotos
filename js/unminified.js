...
(function(window){
	...
	var FWDEVPData = function(props, playListElement){
		...
		self.parseProperties = function(){
			...
			self.mainFolderPath_str = (window.moviemaniaResolvePath ? window.moviemaniaResolvePath(self.props_obj.mainFolderPath, "start/content") : (self.props_obj.mainFolderPath || "https://cdn.jsdelivr.net/gh/HackerTutoriales-SeguridadInformatica/ReproductorGooglePhotos@main/player.moviemania/start/content"));
...
(function (window){
	...
	var FWDEVPlayer = function(props){
		...
		self.mainFolderPath_str = (window.moviemaniaResolvePath ? window.moviemaniaResolvePath(props.mainFolderPath, "start/content") : (props.mainFolderPath || "https://cdn.jsdelivr.net/gh/HackerTutoriales-SeguridadInformatica/ReproductorGooglePhotos@main/player.moviemania/start/content"));
		if((self.mainFolderPath_str.lastIndexOf("/") + 1) != self.mainFolderPath_str.length){
			self.mainFolderPath_str += "/";
		}
